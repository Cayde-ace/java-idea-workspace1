...
public class MethodRefTest {
	...
	public void test5() {
		...
		System.out.println(com.compare("cba","aba"));

		Comparator<String> com1 = (s1,s2) -> s1.compareTo(s2);//compare(s1,s2)不行
		//为什么compare(s1,s2)不行？因为String没有实现Comparator<T>接口，故String没有compare(T o1, T o2)方法。
