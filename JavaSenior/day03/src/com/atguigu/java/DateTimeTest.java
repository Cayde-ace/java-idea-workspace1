...
public class DateTimeTest {
    ...
    3. java.sql.Date对应着数据库中的日期类型的变量
        >如何实例化
        >java.sql.Date ---> java.util.Date 多态 （向上转型）
    ...
    public void test2(){
        //构造器一：Date()：创建一个对应当前时间的Date对象
        Date date1 = new Date();
        System.out.println(date1.toString());//Sat Jul 10 17:46:43 GMT+08:00 2021

        System.out.println(date1.getTime());//1625910403996
...
//        java.sql.Date date5 = (java.sql.Date) date4;
        ...
        System.out.println(date7);//2021-07-10
    }
    ...
    public void test1(){
        ...
        //称为时间戳
        System.out.println(time);//1625910660179
    }
}
